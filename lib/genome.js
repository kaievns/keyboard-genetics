...
console.log(JSON.stringify(genome.toString()));
console.log(genome.toLayout().toString());

let new_genome = genome.mutate(20);

console.log(JSON.stringify(new_genome.toString()));

console.log(genome.merge(new_genome).map(g => JSON.stringify(g.toString())));
