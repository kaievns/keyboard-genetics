...
// export const docs = execSync(DOCS_CMD, {timeout: 0, maxBuffer: 1024 * 1024 * 1024}).toString();

const TEXT_CMD  = "cat text/nyt.txt";
const text = exports.text = execSync(TEXT_CMD, {timeout: 0, maxBuffer: 1024 * 1024 * 1024}).toString();
